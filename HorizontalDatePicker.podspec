...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/HorizontalDatePicker"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Erez Haim" => "erez@livemed.co" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/HorizontalDatePicker.git", :tag => s.version.to_s }
